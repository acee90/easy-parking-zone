/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: f4c4d139b589e2f75965e16736a80361)
// Runtime types generated with workerd@1.20260415.1 2025-04-01 nodejs_compat
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/server/worker-entry");
	}
	interface Env {
		DB: D1Database;
		SCORE_RECOMPUTE_QUEUE: Queue;
		SOURCE_FILTER_QUEUE: Queue;
		RATE_LIMITER_POINTS: RateLimit;
		RATE_LIMITER_DETAIL: RateLimit;
		RATE_LIMITER_EDIT: RateLimit;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "VITE_NAVER_MAP_CLIENT_ID" | "BETTER_AUTH_URL" | "D1_PROXY_TOKEN" | "UNSLOTH_API_KEY" | "CRON_TRIGGER_TOKEN" | "DATA_GO_KR_SERVICE_KEY" | "SEOUL_SERVICE_KEY">> {}
}
