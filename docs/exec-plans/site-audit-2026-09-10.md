...
| 3 | **블라인드 채점: 부적합 항목 수** — 맥락 없는 에이전트가 before/after 목록 110개(714항목)를 A/B 로 섞어 항목별로 판정. 규칙·목표 비율은 알려주지 않음 | 채점 대기 | before 대비 감소, after 잔여 ≤ 2% (7행) | |
| 4 | 반대 지표: 규칙이 막는 lot 전체와 오탐 | — | 무작위 30 표본 블라인드 채점에서 오탐(적합한데 막힘) ≤ 3 | 전체 53,868곳 중 **2,119곳(3.9%)** 제외 — 일반명 1,802 / 시군구명 100 / 도로 86 / 대행·세차 74 / 입구·출구 55 / 공사중 2. 표본 채점 대기 |
