...
| C-1·C-2·D-6 | #210 (09-11) | **완료 (C-2 근소 미달)** | 운영 재측정: 클릭 → 상세 27~58ms, 클릭 → 목록 응답 1.08~1.14s(목표 1초). 지도 이동 250ms 는 코드 상수. 로컬 첫 측정: 목록 1회 클릭 74ms 뒤 상세, 클릭당 목록 조회 1회, 목록 교체 시 20행 리셋 |
