...
- "thin": 본문 200자 미만이거나 주차장에 대한 구체 정보 전무 (위치/요금/운영시간/주차면/혼잡도/진입 중 하나도 없음)
- "boilerplate": SEO 자동생성 템플릿 ("Top5 저렴한 주변 주차정보", 운영시간·요금만 나열, 공식 가이드 톤). 단, 해당 주차장의 실제 요금·이용팁·진입 정보가 있으면 통과 가능
...
- 다음 중 1건 이상 포함:
  1. 사용자 후기: 방문 경험, 진입로, 주차면, 요금, 혼잡도, 편의·불편 묘사
  2. 주차장 정보: 위치, 요금, 운영시간, 주차면수, 무료·유료 여부, 결제·할인, 접근 동선, 이용 팁
- 여러 주차장 나열 문서라도 개별 섹션 또는 인접 문맥에 구체 정보 있으면 통과 가능
