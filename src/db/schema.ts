...
export const parkingLotStats = sqliteTable("parking_lot_stats", {
  parkingLotId: text("parking_lot_id").primaryKey().references(() => parkingLots.id),
...
export const userReviews = sqliteTable("user_reviews", {
  ...
  index("idx_user_reviews_lot").on(table.parkingLotId),
]);
...
export const parkingVotes = sqliteTable("parking_votes", {
  id: integer("id").primaryKey({ autoIncrement: true }),
  ...
  uniqueIndex("idx_parking_votes_unique").on(table.userId, table.parkingLotId),
]);

export const parkingBookmarks = sqliteTable("parking_bookmarks", {
  id: integer("id").primaryKey({ autoIncrement: true }),
  userId: text("user_id").notNull(),
  parkingLotId: text("parking_lot_id").notNull(),
  createdAt: text("created_at").notNull().default(now),
}, (table) => [
  uniqueIndex("idx_parking_bookmarks_unique").on(table.userId, table.parkingLotId),
]);
...
export const cafeSignalLots = sqliteTable("cafe_signal_lots", {
  signalId: integer("signal_id").notNull().references(() => cafeSignals.id, { onDelete: "cascade" }),
  parkingLotId: text("parking_lot_id").notNull(),
}, (table) => [
...
export const curationCandidates = sqliteTable("curation_candidates", {
  id: integer("id").primaryKey({ autoIncrement: true }),
  parkingLotId: text("parking_lot_id").notNull(),
  ...
  uniqueIndex("idx_curation_candidates_unique").on(table.parkingLotId, table.source),
]);
...
export const poiUnmatched = sqliteTable("poi_unmatched", {
  id: integer("id").primaryKey({ autoIncrement: true }),
